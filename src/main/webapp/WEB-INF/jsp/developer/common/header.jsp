            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile">
                    ...
                    <div class="profile_info">
                        <span>欢迎,${devUserSession.devName}</span>
                        <h2></h2>
                    </div>
                </div>
                <!-- /menu profile quick info -->
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> App应用管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="${pageContext.request.contextPath}/app/appinfolist.html">APP维护</a></li>
                                </ul>
                            </li>
                            <!-- /导航条 -->
                        </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                ...
                                <li><a href="${pageContext.request.contextPath}/devuser/logout  "><i class="fa fa-sign-out pull-right"></i> 注销</a></li>
                            </ul>
                        </li>
