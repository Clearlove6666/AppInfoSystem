                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="x_content" style="display: block">
                                <br>
                                <form class="form-horizontal form-label-left" method="post" action="/app/modifyversion" enctype="multipart/form-data">
                                    <input type="hidden" name="appId" value="${appId}">
                                    <input type="hidden" id="id" value="${appVersion.id}">
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" class="form-control" required placeholder="请输入版本号" value="${appVersion.versionNo}" name="versionNo" readonly>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">
